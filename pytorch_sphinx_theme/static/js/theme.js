...
})()(
  {
      ...
      function (require, module, exports) {
        window.utilities = {
          ...
          headersHeight: function () {
            if (
              document
                .getElementById("pytorch-left-menu")
                .classList.contains("make-fixed")
            ) {
              return document.getElementById("pytorch-page-level-bar")
                .offsetHeight;
            } else {
              return (
                document.getElementById("header-holder").offsetHeight +
    ...
    4: [
      function (require, module, exports) {
        ...
        window.highlightNavigation = {
          navigationListItems: document.querySelectorAll(
            "#pytorch-right-menu li"
          ),
          ...
          bind: function () {
            ...
            $(window).scroll(
              utilities.throttle(highlightNavigation.highlight, 100)
            );
          },
          ...
          highlight: function () {
            ...
            for (var i = sections.length - 1; i >= 0; i--) {
              ...
              if (scrollPosition >= sectionTop - offset) {
                var navigationLink =
                  highlightNavigation.sectionIdTonavigationLink[
                    currentSection.id
                  ];
                var navigationListItem = utilities.closest(
                  navigationLink,
                  "li"
                );
                ...
                if (
                  navigationListItem &&
                  !navigationListItem.classList.contains("active")
                ) {
                  for (
                    var i = 0;
                    i < highlightNavigation.navigationListItems.length;
                    i++
                  ) {
    ...
    7: [
      function (require, module, exports) {
        window.mobileTOC = {
          bind: function () {
            $("[data-behavior='toggle-table-of-contents']").on(
              "click",
              function (e) {
                e.preventDefault();
      ...
      function (require, module, exports) {
        window.sideMenus = {
          rightMenuIsOnScreen: function () {
            return (
              document.getElementById("pytorch-content-right").offsetParent !==
              null
            );
          },
          ...
          bind: function () {
            ...
            var rightMenuLinks = document.querySelectorAll(
              "#pytorch-right-menu li"
            );
         ...
         > ul > li > a.reference.internal"
              ...
              var linkWithHash = document.querySelector(
              ...
              $("#pytorch-right-menu a.reference.internal").on(
                "click",
                function () {
          ...
          handleNavBar: function () {
            ...
            if (utilities.scrollTop() >= mainHeaderHeight) {
              document
                .getElementById("pytorch-left-menu")
                .classList.add("make-fixed");
              document
                .getElementById("pytorch-page-level-bar")
                .classList.add("left-menu-is-fixed");
            } else {
              document
                .getElementById("pytorch-left-menu")
                .classList.remove("make-fixed");
              document
                .getElementById("pytorch-page-level-bar")
                .classList.remove("left-menu-is-fixed");
            }
          },
          ...
          handleLeftMenu: function () {
            ...
            var topOfFooterRelativeToWindow = document
              .getElementById("docs-tutorials-resources")
            ...
            if (topOfFooterRelativeToWindow >= windowHeight) {
              ...
              var howManyPixelsOfTheFooterAreInTheWindow =
                windowHeight - topOfFooterRelativeToWindow;
              var leftMenuDifference = howManyPixelsOfTheFooterAreInTheWindow;
              document.getElementById("pytorch-left-menu").style.height =
                windowHeight - leftMenuDifference + "px";
            }
          },

          handleRightMenu: function () {
            var rightMenuWrapper = document.getElementById(
            ...
            if (utilities.scrollTop() < mainHeaderHeight) {
              ...
              if (rightMenu.classList.contains("scrolling-fixed")) {
                var rightMenuBottom =
                  utilities.offset(rightMenuList).top +
                  rightMenuList.offsetHeight;

                if (rightMenuBottom >= articleBottom) {
                  rightMenuWrapper.style.height =
                    articleHeight + mainHeaderHeight + "px";
                  rightMenu.style.top =
                    utilities.scrollTop() - mainHeaderHeight + "px";
              ...
              if (
                utilities.scrollTop() <
                articleBottom - rightMenuList.offsetHeight
              ) {
                rightMenuWrapper.style.height = "100%";
                rightMenu.style.top = "";
                rightMenu.classList.remove("scrolling-absolute");
            ...
            var rightMenuSideScroll = document.getElementById(
              "pytorch-side-scroll-right"
            );
            var sideScrollFromWindowTop =
              rightMenuSideScroll.getBoundingClientRect().top;

            rightMenuSideScroll.style.height =
              utilities.windowHeight() - sideScrollFromWindowTop + "px";
          },
        };
      },
      {},
    ...
    "pytorch-sphinx-theme": [
      function (require, module, exports) {
        ...
        function ThemeNav() {
          ...
          nav.init = function ($) {
            ...
            $(document)
              ...
              .on(
                "click",
                "[data-toggle='pytorch-left-menu-nav-top']",
                function () {
              ...
              .on(
                "click",
                ".pytorch-menu-vertical .current ul li a",
                function () {
                  var target = $(this);
        ...
        if (downloadNote.length >= 1) {
          ...
          var githubLink =
              "https://github.com/pytorch/tutorials/blob/master/" +
              tutorialUrlArray.join("/") +
              ".py",
          ...
          $("#google-colab-link").wrap(
            "<a href=" +
              colabLink +
              " data-behavior='call-to-action-event' data-response='Run in Google Colab' target='_blank'/>"
          );
          $("#download-notebook-link").wrap(
            "<a href=" +
              notebookLink +
              " data-behavior='call-to-action-event' data-response='Download Notebook'/>"
          );
          $("#github-view-link").wrap(
            "<a href=" +
              githubLink +
              " data-behavior='call-to-action-event' data-response='View on Github' target='_blank'/>"
          );
        } else {
          ...
          $(caption).each(function () {
            ...
            if (
              ...
              $(this.firstChild).after(
                "<span class='hide-menu collapse'>-</span>"
              );
              $(this).next("ul").hide();
            } else if (
              (collapsedSections.includes(menuName) == false &&
                collapseAdded) ||
              sessionStorage.getItem(menuName) == "expand"
            ) {
              $(this.firstChild).after(
